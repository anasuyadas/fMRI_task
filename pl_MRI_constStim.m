...
%     if stimulus.FixationBreak(task.trialnum),task.thistrial.thisseg=8; end %task.thistrial.thisseg=8; end 
...
if ~task.thistrial.gotResponse
    ...
    if stimulus.randVars.contrast(task.thistrial.trialIndex) ==  0 %cue-only
